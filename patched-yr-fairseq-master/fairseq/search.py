...
class BeamSearch(Search):
    ...
    def step(self, step, lprobs, scores): # lprob [beam1,vocabsz]
...
class DiverseBeamSearch(Search):
    ...
    def step(self, step, lprobs, scores):
        super()._init_buffers(lprobs)#lprobs[beam=4, vocabsz]
        bsz, beam_size, vocab_size = lprobs.size()
        ...
        for g in range(self.num_groups):
            ...
            scores_buf, indices_buf, beams_buf = self.beam.step(step, lprobs_g, scores_g)#top2 shape[1,2]
        ...
        return self.scores_buf, self.indices_buf, self.beams_buf # [1,8=beam*2]
