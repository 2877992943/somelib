...
class LightConvLanguageModel(FairseqLanguageModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--decoder-embed-path',  default=None,type=str, metavar='STR',
                            help='path to pre-trained decoder embedding') ## add yr
        ...
        parser.add_argument('--decoder-conv-dim', type=int, metavar='N', help='decoder convluticonv dim') ### add lyy
    ...
    def build_model(cls, args, task):
        ...
        if args.character_embeddings:
            ...
            if args.decoder_embed_path:
                embed_dict = utils.parse_embedding(args.decoder_embed_path)
                embed_tokens=utils.load_embedding(embed_dict, task.dictionary, embed_tokens)
...
def base_lm_architecture(args):
    #### add yr
    #args.decoder_embed_path=getattr(args, 'decoder_embed_dim', None)
    #####
