...
class LightConvDecoder(FairseqIncrementalDecoder):
    ...
    def forward(self, prev_output_tokens, encoder_out=None, incremental_state=None, **unused): ## add lyy
        """
        Args:
...
#     from fairseq.models.lightconv import Embedding
#
#     emb = Embedding(num_embeddings, embed_dim, padding_idx)
#     emb.weight.requires_grad=False
#     #emb.from_pretrained(freeze=True)
